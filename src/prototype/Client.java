...
/**
 * @decription:原型设计模式：获得对象，功能类似于工厂模式
 * 客户端只要创建一份对象，而后的可以不断复制，不用在 new了（new的工作交给服务端了）
...
public class Client {
	...
	public static void main(String[] args) throws CloneNotSupportedException {
		...
		//简历原型
		Resume resume = new Resume("bob",24,new Experience("2000-2004", new Company("alibaba","HangZhou")));
